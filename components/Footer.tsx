  ...
  return (
    <footer className="py-24 px-6 md:px-12 bg-[#edede4] border-t border-[#707756]/10">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12">
        ...
        <div className="flex flex-wrap justify-center gap-10 text-[10px] font-bold uppercase tracking-[0.25em] text-[#707756]/60">
          <a href="#" className="hover:text-[#707756] transition-colors">Privacy</a>
          <a href="#" className="hover:text-[#707756] transition-colors">Terms</a>
          <a href="#" className="hover:text-[#707756] transition-colors">Medical Disclaimer</a>
          <a href="#" className="hover:text-[#707756] transition-colors">Contact</a>
        </div>
      </div>
      
      <div className="max-w-4xl mx-auto mt-24 text-center space-y-8">
        <p className="text-[10px] text-zinc-400 leading-relaxed uppercase tracking-wider font-medium max-w-2xl mx-auto">
        ...
        <div className="pt-8 border-t border-[#707756]/5">
          <p className="text-[9px] text-zinc-400 font-bold tracking-[0.1em]">
